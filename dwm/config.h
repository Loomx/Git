...
static Key keys[] = {
	...
	{ 0,                   0x1008ff03,                spawn,          SHCMD("Mon=$(cat /sys/class/backlight/intel_backlight/brightness); echo $((Mon-2000)) >/sys/class/backlight/intel_backlight/brightness") },
	{ 0,                   0x1008ff02,                spawn,          SHCMD("Mon=$(cat /sys/class/backlight/intel_backlight/brightness); echo $((Mon+2000)) >/sys/class/backlight/intel_backlight/brightness") },
