...
static const char *hdmicmd[]      = { "hdmi_hotplug", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,              0xff50,                    spawn,          {.v = playcmd } },
	{ 0,                   0x1008ff15,                spawn,          {.v = stopcmd } },
	{ MODKEY,              0xff57,                    spawn,          {.v = stopcmd } },
	{ 0,                   0x1008ff16,                spawn,          {.v = prevcmd } },
	{ MODKEY,              0xff55,                    spawn,          {.v = prevcmd } },
	{ 0,                   0x1008ff17,                spawn,          {.v = nextcmd } },
	{ MODKEY,              0xff56,                    spawn,          {.v = nextcmd } },
	{ 0,                   0x1008ff12,                spawn,          {.v = mutecmd } },
	{ 0,                   0x1008ff59,                spawn,          {.v = hdmicmd } },
